...
var maxWidth = 740;
var logoScale = innerWidth <= maxWidth ? innerWidth / maxWidth : 2;
...
logoTimeline
  ...
  translateX: [
    ...
    { value: [-600, 0], duration: 500, delay: 1000, easing: 'easeOutQuart' }
  ],
  scale: [
  ...
  stroke: {
    value: ['#F4D8CD', function(el) { return anime.getValue(el.parentNode, 'stroke') } ],
    duration: 500,
    delay: 500,
    easing: 'easeInQuad'
  },
